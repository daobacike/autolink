package com.chuck.autolink.media;
...
import com.chuck.autolink.MainActivity;
import com.chuck.autolink.screen.VideoInfo;
...
public class VideoMediaCodec extends MediaCodecBase {
    ...
    public void prepare(){
        try{
            MediaFormat format = MediaFormat.createVideoFormat(VideoInfo.MIME_TYPE, VideoInfo.VIDEO_WIDTH, VideoInfo.VIDEO_HEIGHT);
            format.setInteger(MediaFormat.KEY_COLOR_FORMAT,
                    MediaCodecInfo.CodecCapabilities.COLOR_FormatSurface);
            format.setInteger(MediaFormat.KEY_BIT_RATE, VideoInfo.VIDEO_BITRATE);
            format.setInteger(MediaFormat.KEY_FRAME_RATE, VideoInfo.VIDEO_FRAMERATE);
            format.setInteger(MediaFormat.KEY_I_FRAME_INTERVAL, VideoInfo.VIDEO_IFRAME_INTER);
            mEncoder = MediaCodec.createEncoderByType(VideoInfo.MIME_TYPE);
